...
public class Mon_Bat extends Entity{
    O_GamePanel ogp;
    public Mon_Bat(O_GamePanel ogp) {
        super(ogp);
        this.ogp = ogp;
        name = "Bat";
        direction = "S";
    ...
    public void getMonsImage(){
        this.W1 = setup("/res/monster/bat_down_1", ogp.tileSizeW,ogp.tileSizeH);
        this.W2 = setup("/res/monster/bat_down_2", ogp.tileSizeW,ogp.tileSizeH);
        
        this.S1 = setup("/res/monster/bat_down_1", ogp.tileSizeW,ogp.tileSizeH);
        this.S2 = setup("/res/monster/bat_down_2", ogp.tileSizeW,ogp.tileSizeH);
        
        this.D1 = setup("/res/monster/bat_down_1", ogp.tileSizeW,ogp.tileSizeH);
        this.D2 = setup("/res/monster/bat_down_2", ogp.tileSizeW,ogp.tileSizeH);
        
        this.A1 = setup("/res/monster/bat_down_1", ogp.tileSizeW,ogp.tileSizeH);
        this.A2 = setup("/res/monster/bat_down_2", ogp.tileSizeW,ogp.tileSizeH);
